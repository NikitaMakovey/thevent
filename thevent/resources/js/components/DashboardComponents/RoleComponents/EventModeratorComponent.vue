    ...
    <div class="album">
        ...
        >
            <div class="row" style="height: 94vh">
                <div class="col-md-4" v-for="event in EM_REQUESTS" :key="event.id">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group">
                                    <v-btn
                                        ...
                                        :to="{ name: 'em-request', params: { id: event.id } }"
                                    >
                                        Проверить
                                    </v-btn>
                                </div>
...
<script>
    ...
    export default {
        mounted() {
            ...
            this.$store.dispatch('GET_EM_REQUESTS', config);
        },
        computed: {
            ...mapGetters(['EM_REQUESTS'])
        }
    }
</script>
