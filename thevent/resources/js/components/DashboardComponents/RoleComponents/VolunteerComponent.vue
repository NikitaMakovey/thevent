    ...
    <div class="album">
        ...
        >
            <div class="row" style="height: 94vh">
                <div class="col-md-4" v-for="event in V_REQUESTS" :key="event.event_id">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group">
                                    <v-btn
                                        ...
                                        :to="{ name: 'v-request', params: { id: event.event_id } }"
                                    >
                                        Просмотреть
                                    </v-btn>
                                </div>
...
<script>
    ...
    export default {
        mounted() {
            ...
            this.$store.dispatch('GET_V_REQUESTS', config);
        },
        computed: {
            ...mapGetters(['V_REQUESTS'])
        }
    }
</script>
